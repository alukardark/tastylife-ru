...
<?
$frame = $this->createFrame("bx-yandex-view-layout", false)->begin();
?>
<div class="bx-yandex-view-layout">
	<div class="bx-yandex-view-map">
<?
	$APPLICATION->IncludeComponent('bitrix:map.yandex.system', 'yandex_system', $arTransParams, false, array('HIDE_ICONS' => 'Y'));
?>
	</div>
</div>
<?$frame->end();?>
