	...
	<?if($count % 3 == 0) echo "<div class='three_block'>"; $count += 1;?>
		<article class="news_section_item" itemscope itemtype="http://schema.org/Article">
			<a href="<?=$arSection["SECTION_PAGE_URL"];?>" class="animation_img">
				...
				<img src="<?=$arSection["PICTURE"]["SRC"];?>" alt="<?=$arSection["NAME"]?>" title="<?=$arSection["NAME"]?>" itemprop="image" />
				<span class="link"><i class="fa fa-link"></i></span>
			</a>
			<div class="description">
				<h2>
					<a rel="bookmark" href="<?=$arSection["SECTION_PAGE_URL"]?>" itemprop="name"><?=$arSection["NAME"]?></a>
				</h2>
				<div itemprop="description">
					<?=$arSection["DESCRIPTION"];?>
				</div>
			</div>
			<p><a href="<?=$arSection["SECTION_PAGE_URL"]?>" itemprop="url">Читать далее</a></p>
		</article>
